...
public class FoodContract {
     ...
     */
    public static final String PATH_WEATHER = "food";
    ...
    public static final class FoodEntry implements BaseColumns {
        ...
        public static final String COLUMN_NAME = "weather_id";
       ...
       // public static final String COLUMN_DEGREES = "degrees";
        ...
        public static String getSqlSelectForTodayOnwards() {
            long normalizedUtcNow = CustomDateUtils.normalizeDate(System.currentTimeMillis());
            return FoodEntry.COLUMN_DATE + " >= " + normalizedUtcNow;
        }
    }
}