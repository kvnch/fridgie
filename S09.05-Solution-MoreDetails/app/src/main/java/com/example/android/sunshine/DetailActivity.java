...
//  COMPLETED (19) Create constant int values representing each column name's position above
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDateView = (EditText) findViewById(R.id.et_days_difference);
        mNameView = (EditText) findViewById(R.id.tv_food_name);
    ...
    private Intent createShareForecastIntent() {
        Intent shareIntent = ShareCompat.IntentBuilder.from(this)
                .setType("text/plain")
                .setText(mSummary + FORECAST_SHARE_HASHTAG)
                .getIntent();
...
//      COMPLETED (25) Check before doing anything that the Cursor has valid data
        ...
        int dateText = CustomDateUtils.getDaysDifference(localDateMidnightGmt);

        mDateView.setText(Integer.toString(dateText));

        /* Read weather condition ID from the cursor (ID provided by Open Weather Map) */
        String description = data.getString(INDEX_NAME);

        /* Set the text */
        mNameView.setText(description);

        /* Store the forecast summary String in our forecast summary field to share later */
        mSummary = String.format("%s - %s",
