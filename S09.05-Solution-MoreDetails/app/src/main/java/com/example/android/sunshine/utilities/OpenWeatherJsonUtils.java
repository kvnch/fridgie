...
//
//        long startDay = CustomDateUtils.getNormalizedUtcDateForToday();
//
...
//             */
//            dateTimeMillis = startDay + CustomDateUtils.DAY_IN_MILLIS * i;
//            date = CustomDateUtils.getDaysDifference(context, dateTimeMillis, false);
//
//            /*
...
//////        long normalizedUtcStartDay = CustomDateUtils.normalizeDate(now);
////
////        long normalizedUtcStartDay = CustomDateUtils.getNormalizedUtcDateForToday();
////
...
////             * the values are returned in-order by day (which is not guaranteed to be correct).
////             */
////            dateTimeMillis = normalizedUtcStartDay + CustomDateUtils.DAY_IN_MILLIS * i;
////
...
////            weatherValues.put(FoodContract.WeatherEntry.COLUMN_DATE, dateTimeMillis);
////            weatherValues.put(FoodContract.WeatherEntry.COLUMN_NAME, weatherId);
////
